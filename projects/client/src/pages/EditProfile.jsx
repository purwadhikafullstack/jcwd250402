...
import { UploadPhoto, ChangePassword, Navbar } from "../components/";
...
export default function EditProfile() {
  ...
  return (
    <Navbar>
      <section className="flex flex-col items-center justify-center w-[100%] min-h-screen bg-white rounded-md">
        <div className="w-full p-8 mt-20 bg-white rounded-md shadow-lg">
