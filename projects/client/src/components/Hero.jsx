...
const Hero = () => {
  return (
    <div
      id="hero_section"
      className="relative flex flex-col items-center justify-center w-full h-screen bg-center md:justify-center md:flex md:flex-col md:h-screen md:bg-cover md:bg-left md:bg-no-repeat"
    ...
    >
      <div className="z-10 flex flex-col mx-8 text-center text-white md:text-left md:mx-0 md:w-1/2 md:pl-8">
        ...
        <p className="hidden mb-32 text-xl leading-relaxed md:block md:text-2xl">
